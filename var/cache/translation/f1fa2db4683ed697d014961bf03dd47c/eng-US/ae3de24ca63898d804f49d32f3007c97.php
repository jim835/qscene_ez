...
$TranslationRoot = array (
  ...
  array (
    ...
    'comment' => NULL,
    'translation' => 'Navigate using the available tabs (above), the tree menu (left) and the content list (middle).',
  ...
  array (
    ...
    'comment' => NULL,
    'translation' => 'Choose location for the copy of <%object_name>',
  ...
  array (
    ...
    'comment' => NULL,
    'translation' => 'Choose location for the copy of subtree of node <%node_name>',
  ...
  array (
    ...
    'comment' => NULL,
    'translation' => 'Choose a new location for the copy of <%object_name> using the radio buttons then click "Select".',
  ...
  array (
    ...
    'comment' => NULL,
    'translation' => 'Choose a new location for the copy of subtree of node <%node_name> using the radio buttons then click "Select".',
