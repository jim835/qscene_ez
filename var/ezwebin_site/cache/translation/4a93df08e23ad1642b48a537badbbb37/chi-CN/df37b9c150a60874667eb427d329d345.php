...
$TranslationRoot = array (
  ...
  array (
    ...
    'comment' => NULL,
    'translation' => '查看和管理（复制，删除，等）此对象的版本。',
  ...
  array (
    ...
    'comment' => NULL,
    'translation' => '使用选中语言，位置及设计查看当前显示的版本。',
  ...
  array (
    ...
    'comment' => NULL,
    'translation' => '您不能管理该对象的版本因为只有一个版本可用（正被显示的版本）。',
  ...
  array (
    ...
    'comment' => NULL,
    'translation' => '你所选的翻译与你的存取网址的语言不匹配，这样可能会导致在预览时有未预期的结果，不过也可能是你所想要的。',
