...
$TranslationRoot = array (
  ...
  array (
    ...
    'comment' => NULL,
    'translation' => 'RSS导出%name目前被%user锁定，且最后修改于%datetime。',
  ...
  array (
    ...
    'comment' => NULL,
    'translation' => '只有修改者保存修改或在%datetime解除锁定后，才可以编辑该RSS导出。',
  ...
  array (
    ...
    'comment' => NULL,
    'translation' => 'RSS导入%name目前被%user锁定，且最后修改于%datetime。',
  ...
  array (
    ...
    'comment' => NULL,
    'translation' => '只有修改者保存修改或在%datetime解除锁定后，才可以编辑该RSS导入。',
  ...
  array (
    ...
    'comment' => NULL,
    'translation' => '请选择要导出的位置。

   选择位置并点击%buttonname按钮。
   也可以使用最近项目及书签里的项目来快速选择位置。
   点击位置名修改浏览列表。',
  ...
  array (
    ...
    Click on placement names to change the browse listing.',
    'comment' => NULL,
    'translation' => '请选择要导入对象的所有者。

   选择用户并点击%buttonname按钮。
   也可以使用最近项目及书签里的项目来快速选择。
   点击位置名修改浏览列表。',
