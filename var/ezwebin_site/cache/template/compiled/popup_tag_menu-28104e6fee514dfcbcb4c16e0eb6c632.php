...
// Timestamp: 1330513580 (Wed Feb 29 19:06:20 CST 2012)
$oldSetArray_f37d9495aa513de7f3c150fea9aaa060 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
if ( $if_cond )
{
$text .= '    menuArray[\'TagMenu\'][\'elements\'][\'add-child-tag\'] = { \'url\': "/index.php/ezwebin_site_admin/tags/add/%tagID%" };';
}
unset( $if_cond );
// if ends
...
if ( $if_cond )
{
$text .= '    menuArray[\'TagMenu\'][\'elements\'][\'edit-tag\'] = { \'url\': "/index.php/ezwebin_site_admin/tags/edit/%tagID%" };';
}
unset( $if_cond );
// if ends
...
if ( $if_cond )
{
$text .= '    menuArray[\'TagMenu\'][\'elements\'][\'delete-tag\'] = { \'url\': "/index.php/ezwebin_site_admin/tags/delete/%tagID%" };';
}
unset( $if_cond );
// if ends
...
if ( $if_cond )
{
$text .= '    menuArray[\'TagMenu\'][\'elements\'][\'merge-tag\'] = { \'url\': "/index.php/ezwebin_site_admin/tags/merge/%tagID%" };';
}
unset( $if_cond );
// if ends
...
if ( $if_cond )
{
$text .= '    menuArray[\'TagMenu\'][\'elements\'][\'add-synonym-tag\'] = { \'url\': "/index.php/ezwebin_site_admin/tags/addsynonym/%tagID%" };';
}
unset( $if_cond );
// if ends
...
if ( $if_cond )
{
$text .= '    menuArray[\'TagMenu\'][\'elements\'][\'make-synonym-tag\'] = { \'url\': "/index.php/ezwebin_site_admin/tags/makesynonym/%tagID%" };';
}
unset( $if_cond );
// if ends
...
$text .= '    menuArray[\'TagMenuSimple\'] = { \'depth\': 0, \'headerID\': \'tag-simple-header\' };
    ...
    menuArray[\'TagMenuSimple\'][\'elements\'][\'add-child-tag-simple\'] = { \'url\': "/index.php/ezwebin_site_admin/tags/add/%tagID%" };';
}
unset( $if_cond );
// if ends
...
$setArray = $oldSetArray_f37d9495aa513de7f3c150fea9aaa060;
$tpl->Level--;
?>
