...
$oldSetArray_45323955816d71eb7b77ba9bae8ab5dd = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
<p class="small">design/standard/templates/content/datatype/view/ezxmltags/ul.tpl</p><br/>
...
$setArray = $oldSetArray_45323955816d71eb7b77ba9bae8ab5dd;
$tpl->Level--;
?>
