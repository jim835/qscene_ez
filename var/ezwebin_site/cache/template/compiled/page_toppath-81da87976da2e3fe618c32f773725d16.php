...
$oldSetArray_6649e7f7cde6d40c16285e2b508fdb70 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '
<p class="path"><span class="path-here-text">你的位置:</span>';
unset( $loopItem );
unset( $loopItem );
...
$setArray = $oldSetArray_6649e7f7cde6d40c16285e2b508fdb70;
$tpl->Level--;
?>
