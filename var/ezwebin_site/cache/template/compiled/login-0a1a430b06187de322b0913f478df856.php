...
$oldSetArray_334497e36eadc1e3671969fb239bdf25 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
<form method="post" action="/index.php/chi/user/login" name="loginform">
...
$text .= '
<div class="block">
<label for="id1">用户名</label><div class="labelbreak"></div>
...
<div class="block">
<label for="id2">密码</label><div class="labelbreak"></div>
<input class="halfbox" type="password" size="10" name="Password" id="id2" value="" tabindex="1" />
</div>';
// if begins
$if_cond = 'http://localhost/index.php/ezwebin_site_admin/user/login';
if ( $if_cond )
{
$text .= '    <div class="button-right">
    <a href="http://localhost/index.php/ezwebin_site_admin/user/login">登录至eZ Publish后台</a>
    </div>';
}
unset( $if_cond );
// if ends
...
<input type="checkbox" tabindex="1" name="Cookie" id="id4" /><label for="id4" style="display:inline;">记住登录状态</label>
</div>';
}
unset( $if_cond );
// if ends
...
<input class="defaultbutton" type="submit" name="LoginButton" value="登录" tabindex="1" />';
// if begins
unset( $if_cond );
if (! isset( $if_cond ) ) $if_cond = NULL;
while ( is_object( $if_cond ) and method_exists( $if_cond, 'templateValue' ) )
...
if ( $if_cond )
{
$text .= '    <input class="button" type="submit" name="RegisterButton" id="RegisterButton" value="注册" tabindex="1" />';
}
unset( $if_cond );
// if ends
...
if ( $if_cond )
{
$text .= '    <p><a href="/index.php/chi/user/forgotpassword">忘记密码?</a></p>';
}
unset( $if_cond );
// if ends
...
$setArray = $oldSetArray_334497e36eadc1e3671969fb239bdf25;
$tpl->Level--;
?>
