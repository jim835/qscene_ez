...
// Timestamp: 1331119515 (Wed Mar 7 19:25:15 CST 2012)
$oldSetArray_d52184e68062a7e5fd9c2704882745e7 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
<p class="small">design/standard/templates/navigator/google.tpl</p><br/>
';
...
$text .= '><span class="text">&laquo;&nbsp;上一页</span></a></span>
       ';
    } break;
    case 1:
    {
...
$text .= '><span class="text">下一页&nbsp;&raquo;</span></a></span>
      ';
    } break;
    default:
    {
...
$setArray = $oldSetArray_d52184e68062a7e5fd9c2704882745e7;
$tpl->Level--;
?>
