...
$oldSetArray_3a95d5922f821391ef51ca8656f3b5d5 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '
<!-- START: including template: extension/ezwebin/design/ezwebin/templates/page_header_links.tpl (extension/ezwebin/design/ezwebin/templates/page_header_links.tpl) -->
<p class="small">extension/ezwebin/design/ezwebin/templates/page_header_links.tpl</p><br/>
<div id="links">
    <ul>
        ';
// if begins
...
if ( $if_cond )
{
$text .= '        <li id="shoppingbasket"><a href="/index.php/shop/basket" title="';
unset( $var );
unset( $var1 );
unset( $var1 );
$var1 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'pagedesign', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['pagedesign'] : null;
...
if ( $if_cond )
{
$text .= '        <li id="myprofile"><a href="/index.php/user/edit" title="';
unset( $var );
unset( $var1 );
unset( $var1 );
$var1 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'pagedesign', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['pagedesign'] : null;
...
if ( $if_cond )
{
$text .= '        <li id="logout"><a href="/index.php/user/logout" title="';
unset( $var );
unset( $var1 );
unset( $var1 );
$var1 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'pagedesign', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['pagedesign'] : null;
...
if ( $if_cond )
{
$text .= '        <li id="registeruser"><a href="/index.php/user/register" title="';
unset( $var );
unset( $var1 );
unset( $var1 );
$var1 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'pagedesign', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['pagedesign'] : null;
...
if ( $if_cond )
{
$text .= '        <li id="login"><a href="/index.php/user/login" title="';
unset( $var );
unset( $var1 );
unset( $var1 );
$var1 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'pagedesign', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['pagedesign'] : null;
...
<!-- STOP: including template: extension/ezwebin/design/ezwebin/templates/page_header_links.tpl (extension/ezwebin/design/ezwebin/templates/page_header_links.tpl) -->
';

$setArray = $oldSetArray_3a95d5922f821391ef51ca8656f3b5d5;
$tpl->Level--;
?>
