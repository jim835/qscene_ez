...
$oldSetArray_ccee239d609aae5559acbe28d721bd5c = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
if ( $if_cond )
{
$text .= '        <li id="shoppingbasket"><a href="/index.php/chi/shop/basket" title="';
unset( $var );
unset( $var1 );
unset( $var1 );
$var1 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'pagedesign', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['pagedesign'] : null;
...
if ( $if_cond )
{
$text .= '        <li id="myprofile"><a href="/index.php/chi/user/edit" title="';
unset( $var );
unset( $var1 );
unset( $var1 );
$var1 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'pagedesign', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['pagedesign'] : null;
...
if ( $if_cond )
{
$text .= '        <li id="logout"><a href="/index.php/chi/user/logout" title="';
unset( $var );
unset( $var1 );
unset( $var1 );
$var1 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'pagedesign', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['pagedesign'] : null;
...
if ( $if_cond )
{
$text .= '        <li id="registeruser"><a href="/index.php/chi/user/register" title="';
unset( $var );
unset( $var1 );
unset( $var1 );
$var1 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'pagedesign', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['pagedesign'] : null;
...
if ( $if_cond )
{
$text .= '        <li id="login"><a href="/index.php/chi/user/login" title="';
unset( $var );
unset( $var1 );
unset( $var1 );
$var1 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'pagedesign', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['pagedesign'] : null;
...
$setArray = $oldSetArray_ccee239d609aae5559acbe28d721bd5c;
$tpl->Level--;
?>
