...
$oldSetArray_e19457ad335238a3696e23b61fb4399c = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
<p class="small">extension/ezwebin/design/ezwebin/templates/content/datatype/view/ezxmltags/paragraph.tpl</p><br/>
';
unset( $var );
unset( $var1 );
unset( $var2 );
...
$setArray = $oldSetArray_e19457ad335238a3696e23b61fb4399c;
$tpl->Level--;
?>
