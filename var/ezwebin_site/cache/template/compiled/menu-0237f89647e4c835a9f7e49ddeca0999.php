...
// Timestamp: 1331119530 (Wed Mar 7 19:25:30 CST 2012)
$oldSetArray_5f144e8ca3cc4c107f1bf3ba80936008 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$oldRestoreIncludeArray_2461c975c1bf3c259f93447cfc544486 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$vars[$currentNamespace]['i18n_hash'] = array (
  ...
  'my_drafts' => '我的草稿',
  'my_pending' => '我的待处理项目',
  'my_notifications' => '我的通知设置',
  'my_bookmarks' => '我的书签',
  'collaboration' => '协作',
  'change_password' => '修改密码',
  'my_shopping_basket' => '我的购物篮',
  'my_wish_list' => '我的希望列表',
  'edit_profile' => '编辑档案',
  'dashboard' => '面板',
);
...
$resourceFound = false;
if ( file_exists( 'var/ezwebin_site/cache/template/compiled/ini_menu-9b2419bf9efe09d44c72adc6bbcf5ad8.php' ) )
{
$resourceFound = true;
...
include( '' . 'var/ezwebin_site/cache/template/compiled/ini_menu-9b2419bf9efe09d44c72adc6bbcf5ad8.php' );
...
$restoreIncludeArray = $oldRestoreIncludeArray_2461c975c1bf3c259f93447cfc544486;
...
<div id="contentstructure">
    ';
$oldRestoreIncludeArray_ce21e87faf65b347c1e9b3354bdf0402 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezwebin_site/cache/template/compiled/content_structure_menu_dynamic-8ba97de5ede7afcc424a369bc25033e9.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezwebin_site/cache/template/compiled/content_structure_menu_dynamic-8ba97de5ede7afcc424a369bc25033e9.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_ce21e87faf65b347c1e9b3354bdf0402;
...
$setArray = $oldSetArray_5f144e8ca3cc4c107f1bf3ba80936008;
$tpl->Level--;
?>
