...
$oldSetArray_57fd59c444c50a58722f45d1d4a16cf1 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '
<!-- START: including template: design/standard/templates/setup/clear_cache.tpl (design/standard/templates/setup/clear_cache.tpl) -->
<p class="small">design/standard/templates/setup/clear_cache.tpl</p><br/>
';
unset( $var );
...
unset( $var );
$text .= '
<form id="clearcache" action="/index.php/chi/setup/cachetoolbar" method="post">';
...
$text .= ' type="submit" name="ClearCacheButton" value="清除" />
</div>';
...
$text .= '
<!-- STOP: including template: design/standard/templates/setup/clear_cache.tpl (design/standard/templates/setup/clear_cache.tpl) -->
';

$setArray = $oldSetArray_57fd59c444c50a58722f45d1d4a16cf1;
$tpl->Level--;
?>
