<?php
// URI:       extension/qstest/design/qstest/templates/page_header_logo.tpl
// Filename:  extension/qstest/design/qstest/templates/page_header_logo.tpl
// Timestamp: 1333608469 (Thu Apr 5 14:47:49 CST 2012)
$oldSetArray_a36554d745cbbb8f8c48351232ef5122 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '
<!-- START: including template: extension/qstest/design/qstest/templates/page_header_logo.tpl (extension/qstest/design/qstest/templates/page_header_logo.tpl) -->
<p class="small">extension/qstest/design/qstest/templates/page_header_logo.tpl</p><br/>
<div id="logo">';
// if begins
unset( $if_cond );
unset( $if_cond1 );
...
if ( $if_cond )
{
$text .= '    <h1><a href="/index.php" title="';
unset( $var );
...
$text .= '</div>
<!-- STOP: including template: extension/qstest/design/qstest/templates/page_header_logo.tpl (extension/qstest/design/qstest/templates/page_header_logo.tpl) -->
';

$setArray = $oldSetArray_a36554d745cbbb8f8c48351232ef5122;
$tpl->Level--;
?>
