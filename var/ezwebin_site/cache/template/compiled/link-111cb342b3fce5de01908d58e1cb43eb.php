...
$oldSetArray_5af362f01afb91f2fd0556677f1ba0e2 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '
<link rel="Home" href="/index.php/chi" title="';
unset( $var );
unset( $var1 );
unset( $var3 );
unset( $var4 );
...
$text .= '" />
<link rel="Index" href="/index.php/chi" />
<link rel="Top"  href="/index.php/chi" title="';
unset( $var );
unset( $var );
...
$text .= '" />
<link rel="Search" href="/index.php/chi/content/advancedsearch" title="';
unset( $var );
unset( $var1 );
unset( $var3 );
unset( $var4 );
...
<link rel="Copyright" href="/index.php/chi/ezinfo/copyright" />
<link rel="Author" href="/index.php/chi/ezinfo/about" />
';
// if begins
unset( $if_cond );
unset( $if_cond1 );
...
$setArray = $oldSetArray_5af362f01afb91f2fd0556677f1ba0e2;
$tpl->Level--;
?>
