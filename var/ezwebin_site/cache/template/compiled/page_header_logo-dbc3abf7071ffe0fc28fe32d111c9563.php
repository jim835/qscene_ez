...
$oldSetArray_b4cd6808e76400b9cfef82f00d316f03 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
if ( $if_cond )
{
$text .= '    <h1><a href="/index.php/chi" title="';
unset( $var );
...
{
$text .= '    <a href="/index.php/chi" title="';
unset( $var );
$var = 'Website Interface' ;
if (! isset( $var ) ) $var = NULL;
while ( is_object( $var ) and method_exists( $var, 'templateValue' ) )
...
$setArray = $oldSetArray_b4cd6808e76400b9cfef82f00d316f03;
$tpl->Level--;
?>
