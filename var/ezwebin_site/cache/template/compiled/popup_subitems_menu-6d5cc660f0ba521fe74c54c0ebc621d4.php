...
// Timestamp: 1331119519 (Wed Mar 7 19:25:19 CST 2012)
$oldSetArray_4060c50dbdd826440b7fbb1cf11d9818 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
<div class="popupmenu" id="SubitemsContextMenu">
    ...
    <a id="child-menu-preview" href="#" onmouseover="ezpopmenu_mouseOver( \'SubitemsContextMenu\' )">预览</a>';
// if begins
unset( $if_cond );
unset( $if_cond );
...
if ( $if_cond )
{
$text .= '    <a id="child-menu-edit-in" class="more" href="#" onmouseover="ezpopmenu_showSubLevel( event, \'EditSubmenu\', \'child-menu-edit-in\' ); return false;">编辑</a>';
}
else
{
$text .= '    <a id="child-menu-edit" href="#" onmouseover="ezpopmenu_mouseOver( \'SubitemsContextMenu\' )">编辑</a>';
}
unset( $if_cond );
// if ends
...
$setArray = $oldSetArray_4060c50dbdd826440b7fbb1cf11d9818;
$tpl->Level--;
?>
