...
$oldSetArray_b221142e8cd9353ae200aa85a61e6832 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
if ( $if_cond )
{
$text .= '	       <h4><span class="disabled">清除缓存</span></h4>
	    ';
}
else
{
...
<div class="box-bc"><div class="box-ml"><div class="box-content">
    ...
    ';
$oldRestoreIncludeArray_77487e187a26103d6c2d531f16c63aa0 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$restoreIncludeArray = $oldRestoreIncludeArray_77487e187a26103d6c2d531f16c63aa0;
...
$setArray = $oldSetArray_b221142e8cd9353ae200aa85a61e6832;
$tpl->Level--;
?>
