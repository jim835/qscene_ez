...
$oldSetArray_652d20cb6093659dfee8bcca990dc0bf = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '
<!-- START: including template: extension/qstest/design/qstest/templates/left_side_news.tpl (extension/qstest/design/qstest/templates/left_side_news.tpl) -->
<p class="small">extension/qstest/design/qstest/templates/left_side_news.tpl</p><br/>
';
// def $left_news
unset( $var );
...
<!-- STOP: including template: extension/qstest/design/qstest/templates/left_side_news.tpl (extension/qstest/design/qstest/templates/left_side_news.tpl) -->
';

$setArray = $oldSetArray_652d20cb6093659dfee8bcca990dc0bf;
$tpl->Level--;
?>
