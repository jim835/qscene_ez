...
$oldSetArray_73d732351335ea370bf850bdd731405d = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
<p class="small">design/standard/templates/content/datatype/view/ezxmltags/table.tpl</p><br/>
';
unset( $var );
unset( $var1 );
unset( $var2 );
...
$setArray = $oldSetArray_73d732351335ea370bf850bdd731405d;
$tpl->Level--;
?>
