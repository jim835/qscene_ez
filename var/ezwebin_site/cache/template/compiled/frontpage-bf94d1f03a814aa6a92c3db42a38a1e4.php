...
$oldSetArray_f2a4201124c20fa3e5e8bfcd03d4a238 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$nod_f2a4201124c20fa3e5e8bfcd03d4a238 = $object->attribute( 'data_map' );
else
$nod_f2a4201124c20fa3e5e8bfcd03d4a238 = false;
unset( $node, $object );

$text .= '
<!-- START: including template: extension/ezwebin/design/ezwebin/override/templates/full/frontpage.tpl (design:node/view/full.tpl) -->
<p class="small">extension/ezwebin/design/ezwebin/override/templates/full/frontpage.tpl</p><br/>
';
...
// if begins
unset( $if_cond );
$if_cond = $nod_f2a4201124c20fa3e5e8bfcd03d4a238;
if ( !$if_cond )
{
unset( $if_cond );
...
$text .= '    <div class="attribute-billboard">
        ';
unset( $var );
$var = $nod_f2a4201124c20fa3e5e8bfcd03d4a238;
if ( !$var )
{
unset( $var );
...
{
$resourceFound = false;
if ( file_exists( 'var/ezwebin_site/cache/template/compiled/banner-e958eb06ccf5d1a0ad3cfc82a9e3ce06.php' ) )
{
$resourceFound = true;
...
include( '' . 'var/ezwebin_site/cache/template/compiled/banner-e958eb06ccf5d1a0ad3cfc82a9e3ce06.php' );
...
{
$resourceFound = false;
if ( file_exists( 'var/ezwebin_site/cache/template/compiled/flash-c2045f1eed11e637aadd783d6321d8cf.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$currentNamespace = $rootNamespace = !$currentNamespace ? 'ContentView' : ( $currentNamespace . ':' . 'ContentView' );
...
include( '' . 'var/ezwebin_site/cache/template/compiled/flash-c2045f1eed11e637aadd783d6321d8cf.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
{
$resourceFound = false;
if ( file_exists( 'var/ezwebin_site/cache/template/compiled/billboard-ffd6e712060cc1f1ecaa0bfeeba2feee.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$currentNamespace = $rootNamespace = !$currentNamespace ? 'ContentView' : ( $currentNamespace . ':' . 'ContentView' );
...
include( '' . 'var/ezwebin_site/cache/template/compiled/billboard-ffd6e712060cc1f1ecaa0bfeeba2feee.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
<!-- STOP: including template: extension/ezwebin/design/ezwebin/override/templates/full/frontpage.tpl (design:node/view/full.tpl) -->
';

$setArray = $oldSetArray_f2a4201124c20fa3e5e8bfcd03d4a238;
$tpl->Level--;
?>
