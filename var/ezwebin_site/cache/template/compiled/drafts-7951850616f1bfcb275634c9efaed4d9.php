...
$oldSetArray_c3d1e032ab65ce14ab951f9cab1b8d8f = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '">
                    <img src="/design/standard/images/edit.gif" width="16" height="16" border="0" alt="编辑" />
                </a>
            </td>
        </tr>
    ';
...
$setArray = $oldSetArray_c3d1e032ab65ce14ab951f9cab1b8d8f;
$tpl->Level--;
?>
