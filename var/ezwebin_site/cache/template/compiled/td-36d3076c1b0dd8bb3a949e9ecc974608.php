...
$oldSetArray_f008d0cdb154067bd55f12828a035435 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
<p class="small">design/standard/templates/content/datatype/view/ezxmltags/td.tpl</p><br/>
';
unset( $var );
unset( $var1 );
unset( $var2 );
...
$setArray = $oldSetArray_f008d0cdb154067bd55f12828a035435;
$tpl->Level--;
?>
