...
$oldSetArray_4a09500fd2cf1526282aac445fa4ac58 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '
<!-- START: including template: extension/ezwebin/design/ezwebin/override/templates/datatype/ezxmltext/factbox.tpl (design:content/datatype/view/ezxmltags/factbox.tpl) -->
<p class="small">extension/ezwebin/design/ezwebin/override/templates/datatype/ezxmltext/factbox.tpl</p><br/>
<div class="factbox object-';
// if begins
unset( $if_cond );
unset( $if_cond1 );
unset( $if_cond1 );
...
<!-- STOP: including template: extension/ezwebin/design/ezwebin/override/templates/datatype/ezxmltext/factbox.tpl (design:content/datatype/view/ezxmltags/factbox.tpl) -->
';

$setArray = $oldSetArray_4a09500fd2cf1526282aac445fa4ac58;
$tpl->Level--;
?>
